...
static lv_res_t _create_mbox_benchmark(bool sd_bench)
{
	...
	for (u32 iter_curr = 0; iter_curr < iters; iter_curr++)
	{
		...
		s_printf(txt_buf + strlen(txt_buf), " SEQ 16MB - レート： #C7EA46 %3d.%02d %s#",
		...
		s_printf(txt_buf + strlen(txt_buf), " SEQ  4KB - レート： #C7EA46 %3d.%02d %s# IOPS： #C7EA46 %4d# %4d %4d \n",
		...
		s_printf(txt_buf + strlen(txt_buf), " RND  4KB - レート： #C7EA46 %3d.%02d %s# IOPS： #C7EA46 %4d# %4d %4d \n",
			rate_1k / 1000, (rate_1k % 1000) / 10, mbs_text, iops, 1000000 / pct95, 1000000 / pct05);
...
static lv_res_t _create_window_sdcard_info_status(lv_obj_t *btn)
{
	...
	lv_label_set_text(lb_desc3, "#D4FF00 情報を取得中...#");
