 ...
 */
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(amato_30) \
                               LV_FONT_DECLARE(amato_20) \

#define LV_FONT_DEFAULT        &amato_30     /*Always set a default font from the built-in fonts*/
